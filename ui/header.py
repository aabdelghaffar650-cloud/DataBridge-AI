...
def render_header() -> None:
    ...
    language = st.session_state.get("language", "en").upper()
    ...
    if df is not None:
        ...
        chips.append(_chip("Lang", language, "neutral"))
...
<div class="top-header">
  <div class="top-brand">
    ...
    <div class="subtitle">{safe_html(t('subtitle'))}</div>
  </div>
